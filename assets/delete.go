...
// DeleteForced erases asset from world state even if it is references by another asset, deleting it's references
func (a *Asset) DeleteForced(stub shim.ChaincodeStubInterface) ([]byte, error) {
	var err error
